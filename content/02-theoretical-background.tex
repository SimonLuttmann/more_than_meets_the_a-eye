...
Howeverdefining what exactly counts as a “meaningful” region can be difficult, as human perception is subjective and 
...
\begin{figure}[ht]
    ...
    \caption{Types of image segmentation by \textcite{kirillov_panoptic_2019}}
\end{figure}
...
According to \textcite{zhou_image_2024}, the above-described image segmentation methods fall into the category of generic image segmentation (GIS). 
