...
\textcolor{red}{TODO: noch kurz was zur EVALUATION von segmentation models schreiben! also IoU, dice coefficent, precision/recall, F-measure, MAE, etc. wenigstens kurz erwähnen}
