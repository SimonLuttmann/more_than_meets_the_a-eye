...
-	Subjective \& Objective (Image segmentation evaluation: a survey of methods)

-	SAM: IoU (SAM paper itself)

-	Metrics in SOD: PR, F-measure, MAE (Salient object detection: A survey)
