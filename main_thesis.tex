...
\documentclass[
    ...
    chair=csssa, % csssa machineLearning datascience dips bpm
...
\title{Salient Object Detection for Social Media Images}
...
\author{Annika Terhörst \newline Dominik Eitner \newline Simon Luttmann}
...
\email{annika.terhoerst@uni-muenster.de \newline deitner@uni-muenster.de \newline sluttman@uni-muenster.de}
...
\professor{Prof. Dr. Christian Grimme}

\supervisor{Lucas Stampe, M.Sc.}

% You only have to include the course if you are writing a seminar thesis
\course{More than meets the A-eye: Reflecting Human Vision in Artificial Intelligence}
...
\begin{document}
	...
	\begin{content}
        ...
        \input{content/02-theoretical-background}
        \input{content/03-methodology}
        \input{content/04-results}
