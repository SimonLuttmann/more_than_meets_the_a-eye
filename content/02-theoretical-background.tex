...
% \begin{enumerate}
%     \item Semantic segmentation assigns every pixel in an image a semantic label, such as “car” or “sky”.
%     \item Instance segmentation separates individual objects within the same class, for example distinguishing several people in one image.
%     \item Panoptic segmentation combines both approaches by providing pixel-wise class labels and also identifying individual object instances.
% \end{enumerate}
...
\begin{minipage}[]{0.40\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/segmentation_types.png}
